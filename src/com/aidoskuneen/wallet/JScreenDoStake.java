...
public class JScreenDoStake extends JPanel {
	...
	public JScreenDoStake(String sendingFrom, String availableADKinWEI) {
		...
		JLabel lblSending = new JLabel("Staking ADK");
		...
		JLabel lblNewLabel_3 = new JLabel("ADK Amount to Stake:");
		...
		rdbtnUseGas = new JRadioButton("Pay GAS (instant, 0.21 ADK staking fee)");
		...
		btnCancel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Flow.DoAction("CANCELSTAKE", JScreenDoStake.this, null);
			}
		});
		...
		JButton btnSend = new JButton("Stake !");
		btnSend.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Flow.DoAction("DOSTAKE", JScreenDoStake.this, new String[] {
						useGas?"gas":"pow", // gas
						sendingFrom.trim(),
		...
		txtrSendingAdkSending.setText("Staking ADK:\r\n\r\nStaking ADK with Proof of Work will be free, but it may take up to 2 minutes of local PoW.\r\n\r\nIf you want to send instant transactions, use the \"Pay GAS\" option.");
